export type RelationKind = "belongsTo" | "hasOne";
...
/**
 * Metadados de um relacionamento já resolvidos pelo decorator `@BelongsTo`/`@HasOne`.
 *
 ...
 * - `hasOne`: a chave estrangeira está na entidade RELACIONADA (`foreignKeyProperty`);
